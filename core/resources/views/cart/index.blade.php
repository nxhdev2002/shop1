                ...
                <div class="wrap-table-shopping-cart">
                    <table class="table-shopping-cart">
                        ...
                        <tr class="table_row">
                            ...
                            <td class="column-3">{{number_format($cart->product->price)}} VND</td>
                            <td class="column-4">
                                <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                    ...
                                    <input class="mtext-104 cl3 txt-center num-product" type="number"
                                        name="num-product1" value="{{$cart->product->amount}}">
                            ...
                            <td class="column-5">{{number_format($cart->product->price * $cart->quantity)}} VND</td>
                        </tr>
